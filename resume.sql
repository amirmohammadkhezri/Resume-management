...
CREATE TABLE `menu_tbl` (
  `firstname` varchar(120) COLLATE utf8_persian_ci DEFAULT NULL,
  `lastname` varchar(120) COLLATE utf8_persian_ci DEFAULT NULL,
  `run` text COLLATE utf8_persian_ci,
  `pivast` text COLLATE utf8_persian_ci,
...
INSERT INTO `menu_tbl` (`firstname`, `lastname`, `run`, `pivast`, `tel`, `id`) VALUES
('امیر محمد', 'خضری', '<p>من توضیح دادم</p>\r\n', 'uploader/6507/34468.pdf', '09367788810', 13);
